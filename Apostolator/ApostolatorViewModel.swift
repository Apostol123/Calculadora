...
class ApostolatorViewModel: ObservableObject {
    ...
    lazy var buttons: [[ButtonModel]] = { [
        ...
        ButtonModel(id: 3, text: "➗", textColor: .black, backgroundColor: .orange, action: {
        ...
        ButtonModel(id: 7, text: "X", textColor: .white, backgroundColor: .orange, action: {
      ...
      ButtonModel(id: 11, text: "-", textColor: .white, backgroundColor: .orange, action: {
       ...
       [
        ...
        ButtonModel(id: 15, text: "+", textColor: .white, backgroundColor: .orange, action: {
