    ...
    private func forthRowLandscapeOnlyButtons() -> [ButtonModel]  {
        [
            ...
            ButtonModel(id: 119,
                        ...
                        superIndex: "x",
                        action: {[weak self] in
                            self?.engine.observeEvent(.action(.landscapeAction(.ex)))}),
            ButtonModel(id: 120,
                        text: "x",
                        fontSize: 15,
                        textColor: .white,
            ...
            ButtonModel(id: 121,
                        ...
                        superIndex: "3",
                        action: {[weak self] in
                            self?.engine.observeEvent(.action(.landscapeAction(.x3)))
                        }),
            ButtonModel(id: 122,
                        text: "x",
                        fontSize: 15,
    ...
    private func thirdRowLandscapeOnlyButtons() -> [ButtonModel]  {
        [
            ...
            ButtonModel(id: 113,
                        ...
                        action: {
                            [weak self] in
                                self?.engine.observeEvent(.action(.landscapeAction(.ln)))
                        }),
            ButtonModel(id: 114,
                        text: "",
                        fontSize: 15,
    ...
    private func secondRowLandscapeOnlyButtons() -> [ButtonModel] {
        [
            ButtonModel(id: 107,
                        ...
                        height: buttonLayout.buttonHeight,
                        action: { [weak self] in
                                self?.engine.observeEvent(.action(.landscapeAction(.e)))
                        }),
            ButtonModel(id: 108,
                        text: "tan",
                        fontSize: 15,
            ...
            ButtonModel(id: 111,
                        ...
                        height: buttonLayout.buttonHeight,
                        action: { [weak self] in
                                self?.engine.observeEvent(.action(.landscapeAction(.x)))
                        })
        ]
    }
